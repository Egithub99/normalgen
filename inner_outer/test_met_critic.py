...
inner_assistant = autogen.AssistantAgent(
    ...
    system_message="""
    You are an expert assistant focused on conceptual design and brief discussions. You should avoid any coding tasks.
    Your role is to facilitate brief discussions and provide insights without writing or executing any code.
    """,
    ...
    [
        {
            ...
            "message": tasks[0], 
            # "message": f'{tasks[0]} {process_overview_message}',
            "max_turns": 1, 
