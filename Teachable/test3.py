...
# Define a UserProxyAgent to initiate the chat and ask questions
...
chat_results = user_proxy.initiate_chats(
    [
        {
            "recipient": vector_db_agent,
            "message": f"{ask_vector_db_agent('Name six key steps in the conceptual design.')}",
            "max_turns": 1,
