...
task2 = [
    """Choose an appropriate material to construct in.
    """
       ]
...
lead_engineer = autogen.AssistantAgent(
    name="lead_engineer",
    system_message="""
                    The lead-engineer in this design process. 
                    Ask other agents for advice, do not make decisions yourself.
                    """,
    llm_config=llm_config,
    human_input_mode="NEVER"
)
...
nested_chat_queue = [
    {"recipient": lead_engineer, "summary_method": "last_msg"}, 
    {"recipient": material_agent, "message": task2[0], "summary_method": "last_msg"}, 
