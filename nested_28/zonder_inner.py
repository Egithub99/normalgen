...
planner_agent = autogen.AssistantAgent(
    ...
    system_message="""
    You are a planning expert responsible for coordinating the initial stages of the design process.
    You adhere to the message received in the chat.
    """,
...
nested_chat_queue = [
    {"recipient": planner_agent, "message": process_overview_message, "summary_method": "last_msg", "max_turns": 1},
...
res = user.initiate_chats(
    [
        ...
        },
        {
            ...
            "message": process_overview_message, 
            "max_turns": 1, 
            "summary_method": "last_msg",
        },
        {
